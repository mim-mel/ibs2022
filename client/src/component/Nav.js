        ...
        <NavWrap>
            <NavBox>
                ...
                <IsClickedBlock onClick={()=>isMenuToggle()}>
                    {isMenu ? (<IsClickedImg src='/image/x-mark.png'/>) : (<IsClickedImg src='/image/burger.png'/>)}
                </IsClickedBlock>
            </NavBox>
        </NavWrap>
    )
...
const SubTitle = styled.div`
    ...
    @media screen and (max-width: 1024px) {
        ...
        padding: 15px 80px;
        margin: 0;
        border-bottom: ${props => (props.bottom ? 'rgba(255,255,255,0.2) solid 0.3px' : 'null')} 
    }
...
const DropdownArrow = styled.img`
    ...
    display: none;
    transition: 0.2s;
    transform: ${props=>props.isDropdownClicked?'rotate(180deg)':'rotate(0deg)'};
